...
public class ProduitController implements Initializable {
    ...
    private final ObservableList<Produit> listf = FXCollections.observableArrayList();
...
public class Cell extends ListCell<Produit> {
...
////                img.setImage(image);
            ...
            supprimer.setOnAction(event -> {
                ...
                Produit f = getListView().getItems().get(getIndex());
